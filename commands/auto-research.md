...
- No modifica `docs/aura/adr/ADR-011-los-7-pilares-del-harness.md` (requiere nueva spec)
- No modifica `docs/aura/adr/ADR-011-los-7-pilares-del-harness.md` ni `agents/challenger.md` (son la vara de medición)
